...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Sarah Mitchell",
		role: "Founder & CEO",
		image: "/generated/image-a-happy-financial-services-customer-inte.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"We founded Avido because financial institutions deserve AI solutions that don't compromise on compliance. Our mission is to accelerate responsible AI deployment in banking while maintaining the highest regulatory standards"`}
			/>
